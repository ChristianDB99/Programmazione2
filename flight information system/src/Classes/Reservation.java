...
public class Reservation {
    ...
    private Docente[] docenti; // = new Passenger[numberOfPassengers];
    ...
    public Reservation(int reservationNumber, int numberOfPassengers, Docente[] docenti, String flightNumber, String departureDate, Seat[] reservedSeats) {
    ...
    public void setPassengers(Docente[] passengers) {
        this.docenti = docenti;
    }
    ...
    public void getPassengers() {
     ...
     public Docente[] getDocentiArray() {
   ...
   public String[] getReservedSeats(){
    ...
    public String toString() {
        String array1 = Arrays.toString(docenti);
