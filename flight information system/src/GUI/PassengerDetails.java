...
public class PassengerDetails extends javax.swing.JInternalFrame {
    ...
    public DocenteDetails(String flightID, String [] selectedSeats){
        initComponents();
        ...
        doc = new Docente[selectedSeats.length];
        lblCounter.setText("Docente " + count + " of " + selectedSeats.length);
    ...
    private void initComponents() {
        ...
        setClosable(true);
        setTitle("Inserire informazioni docente\n");
        ...
        jLabel7.setText("Codice Docente");

        reserveBtn.setText("Aggiungi Docente");
        ...
        lblCounter.setText("Docente 0 of 0");

        jComboBox1.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Matematica", "Fisica", "Storia", "Informatica" }));
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                            ...
                            .addGroup(javax.swing.GroupLayout.Alignment.LEADING, layout.createSequentialGroup()
                                ...
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                    ...
                                    .addComponent(contactText, javax.swing.GroupLayout.DEFAULT_SIZE, 216, Short.MAX_VALUE)
    ...
    private void reserveBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_reserveBtnActionPerformed
        ...
        String Nome = fNameText.getText();
        String Cognome = lastNameText.getText();
        String Insegnamento = jComboBox1.getSelectedItem().toString();
        String CodiceDocente = contactText.getText();
        String departureDate = "";
        int resNumber = 0;
        
        
        Name nome = new Name (Nome,Cognome);
